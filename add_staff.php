        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">                        
                    ...
                    <a href="staffs" class="btn btn-primary">Staffs</a>
            </div>
        </nav>
...
if (isset($_POST['submit'])) {
    if(empty($_POST['firstname'])){
        ...
        $staffID = check_input($_POST['account_number']);
        ...
        if($sql->rowcount() >0){
            ...
            $insert->execute([$fname,$lname,$staffID,$gender,$mstatus,$email,$mobile,$password,$address,$role,$Active]);
                    if($insert){
                        $e='Staff Registration Completed !!!';
